# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 15:06:26 2019
...
dir_normal = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\normal_smooth_train'
list_normal = []
...
dir_cnv = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\cnv_smooth_train'
list_cnv = []
...
dir_dme = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\dme_smooth_train'
list_dme = []
...
dir_drusen = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\drusen_smooth_train'
list_drusen = []
...
dir_cnv = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\cnv_smooth_test'
list_cnv = []
for filename in os.listdir(dir_cnv):
    if filename.endswith(".nii"):
        list_cnv.append(os.path.join(dir_cnv,filename))
...
dir_dme = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\dme_smooth_test'
list_dme = []
for filename in os.listdir(dir_dme):
    if filename.endswith(".nii"):
        list_dme.append(os.path.join(dir_dme,filename))
...
dir_drusen = r'C:\Users\hudew\OneDrive\桌面\OCT_classification\drusen_smooth_test'
list_drusen = []
for filename in os.listdir(dir_drusen):
    if filename.endswith(".nii"):
        list_drusen.append(os.path.join(dir_drusen,filename))
